              ...
              return Container(
                ...
                child: ClipRRect(
                  ...
                  child: Container(
                    ...
                    child: Column(
                      children: [
                        // Tournament details section (tappable)
                        GestureDetector(
                          onTap: () {
                          ...
                          child: Container(
                            color: Colors.transparent, // Ensure the GestureDetector area is tappable
...
Text(
  ...
  style: GoogleFonts.poppins(fontSize: 12, color: Colors.white70),
                        ...
                        // Buttons section (separated to avoid gesture conflict)
                        Padding(

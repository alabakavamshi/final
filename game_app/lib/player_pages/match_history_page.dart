...
class _MatchHistoryPageState extends State<MatchHistoryPage> {
  ...
  bool _isPlayerInMatch(Map<String, dynamic>
 match) {
  ...
  Color _getResultColor(Map<String, dynamic> match) {
    ...
    return isPlayerWinner ? Colors.greenAccent : Colors.redAccent;
  }
    ...
    if (_showToast && _toastMessage != null && _toastType != null && mounted) {
      WidgetsBinding.instance.addPostFrameCallback((_) {
        toastification.show(
          context: context,
          type: _toastType!,
          title: Text(_toastType == ToastificationType.error ? 'Error' : 'Info'),
          description: Text(_toastMessage!),
          autoCloseDuration: const Duration(seconds: 3),
          backgroundColor: _toastType == ToastificationType.error ? Colors.red : Colors.blue,
